...
if(isset($_GET['add'])){
   $formula->addFormula($_POST);
}else if(isset($_GET['delete'])){
   $formula->deleteFormula($_GET['delete']);
}
...
<div id="lisFrecuencia">
    <h3>Listado de f&oacute;rmulas</h3>
    <table>
        <tr class="tableTitle">
            <td>Nombre</td>
    ...
    //imprimir la lista de objetivos
        ...
        foreach($lista as $item){
           ...
           echo      '<td><a href="#" onClick="if(confirm(\'Desea eliminar esta fórmula?\')) {sendPage(\'null\',\'modules/parametros/formula/home.php?delete='.$item['IDFORMULA'].'\',\'mod_content\');}"><img src="'.$_SESSION['url'].'/images/icontrash.gif"></a></td>';
           echo '</tr>';
        }
...
<div id="addFrecuencia">
    <h3>Crear nueva f&oacute;rmula</h3>
...
<script type="text/javascript">
   ...
   <?php
     if(!$modo){
        echo "urlDestino = 'modules/parametros/formula/home.php?add=1';";
     }else{
       echo "urlDestino = 'modules/parametros/formula/home.php?editFreq={$_GET['edit']}';";
     }
    ?>
