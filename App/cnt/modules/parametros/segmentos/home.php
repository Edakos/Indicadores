...
<p></p>
<div id="listUnidades">
    <p>Listado de segmentos existentes</p>
    <p></p>
    <table border="1">
        <tr class="tableTitle">
            <td>NOMBRE</td>
    ...
    //imprimir la lista de objetivos
        ...
        foreach($lista as $item){
           ...
           echo      '<td><a href="#" onClick="sendPage(\'null\',\'modules/parametros/segmentos/home.php?edit='.$item['IDSEGMENTO'].'\',\'mod_content\');"><img src="'.$_SESSION['url'].'/images/edit.gif"></a></td>';
           echo      '<td><a href="#" onClick="if(confirm(\'Desea eliminar este segmento?\')) {sendPage(\'null\',\'modules/parametros/segmentos/home.php?delete='.$item['IDSEGMENTO'].'\',\'mod_content\');}"><img src="'.$_SESSION['url'].'/images/icontrash.gif"></a></td>';
           echo '</tr>';
        }
...
<script type="text/javascript">
   ...
   <?php
     if(!$modo){
        echo "urlDestino = 'modules/parametros/segmentos/home.php?add=1';";
     }else{
       echo "urlDestino = 'modules/parametros/segmentos/home.php?editProd={$_GET['edit']}';";
     }
    ?>
